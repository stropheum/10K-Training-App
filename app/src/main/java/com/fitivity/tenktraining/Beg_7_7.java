...
public class Beg_7_7 extends FivePartActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        PART_ONE_DURATION   = 10 * 1000 * 60;
        PART_TWO_DURATION   = 125 * 100 * 60;
        PART_THREE_DURATION = 10 * 1000 * 60;
        PART_FOUR_DURATION  = 125 * 100 * 60;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_beg_7_7, menu);
        return true;
    }
