...
public class Workout_2_5 extends FourteenPartActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PART_ELEVEN_DURATION   =  1 * 1000 * 60;
        PART_TWELVE_DURATION   =  1 * 1000 * 60;
        PART_THIRTEEN_DURATION = 30 * 1000 * 60;
        ...
        PART_NINE_GOAL_PACE     = 7.4 * 1000 * 60;
        PART_TEN_GOAL_PACE      = 15  * 1000 * 60;
        PART_ELEVEN_GOAL_PACE   = 7.4 * 1000 * 60;
        PART_TWELVE_GOAL_PACE   = 15  * 1000 * 60;
        PART_THIRTEEN_GOAL_PACE = 7.4 * 1000 * 60;
        PART_FOURTEEN_GOAL_PACE = 15  * 1000 * 60;
        ...
        PART_ELEVEN_SECONDARY_TITLE   = "7:24 min/mile";
        PART_TWELVE_SECONDARY_TITLE   = "15:00 min/mile";
        PART_THIRTEEN_SECONDARY_TITLE = "7:24 min/mile";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_workout_2_5, menu);
        return true;
    }
