...
public class Com_5_7 extends FourteenPartActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PART_TWELVE_DURATION   = 6 * 1000 * 60;
        ...
        PART_SEVEN_GOAL_PACE    = 6.5;
        PART_EIGHT_GOAL_PACE    = 15.0;
        PART_NINE_GOAL_PACE     = 6.5;
        PART_TEN_GOAL_PACE      = 15.0;
        PART_ELEVEN_GOAL_PACE   = 6.5;
        PART_TWELVE_GOAL_PACE   = 15.0;
        PART_THIRTEEN_GOAL_PACE = 7.0;
        ...
        PART_NINE_SECONDARY_TITLE     = "6:30 min/mile";
        PART_TEN_SECONDARY_TITLE      = "15:00 min/mile";
        PART_ELEVEN_SECONDARY_TITLE   = "6:30 min/mile";
        PART_TWELVE_SECONDARY_TITLE   = "15:00 min/mile";
        PART_THIRTEEN_SECONDARY_TITLE = "7:00 min/mile";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_com_5_7, menu);
        return true;
    }
