...
public class Beg_10_5 extends FourPartActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        PART_ONE_DURATION   = 30 * 1000 * 60;
        PART_TWO_DURATION   = 5 * 1000 * 60;
        PART_THREE_DURATION = 30 * 1000 * 60;
        PART_FOUR_DURATION  = 18 * 1000 * 60;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_beg_10_5, menu);
        return true;
    }
