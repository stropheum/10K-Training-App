...
public class Workout_5_7 extends ElevenPartActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PART_SEVEN_DURATION    =  65 * 100 * 60;
        PART_EIGHT_DURATION    =  6 * 1000 * 60;
        PART_NINE_DURATION     =  6 * 1000 * 60;
        PART_TEN_DURATION      =  20 * 1000 * 60;
        PART_ELEVEN_DURATION   =  15 * 1000 * 60;

        PART_ONE_GOAL_PACE      = 6.5 * 1000 * 60;
        PART_TWO_GOAL_PACE      = 15  * 1000 * 60;
        PART_THREE_GOAL_PACE    = 6.5 * 1000 * 60;
        PART_FOUR_GOAL_PACE     = 15  * 1000 * 60;
        PART_FIVE_GOAL_PACE     = 6.5 * 1000 * 60;
        PART_SIX_GOAL_PACE      = 15  * 1000 * 60;
        PART_SEVEN_GOAL_PACE    = 6.5 * 1000 * 60;
        PART_EIGHT_GOAL_PACE    = 15  * 1000 * 60;
        PART_NINE_GOAL_PACE     = 20 * 1000 * 60;
        PART_TEN_GOAL_PACE      = 7.5  * 1000 * 60;
        PART_ELEVEN_GOAL_PACE   = 15 * 1000 * 60;
        ...
        PART_SEVEN_SECONDARY_TITLE    = "6:30 min/mile";
        PART_EIGHT_SECONDARY_TITLE    = "15:00 min/mile";
        PART_NINE_SECONDARY_TITLE     = "7:24 min/mile";
        PART_TEN_SECONDARY_TITLE      = "20:00 min/mile";
        PART_ELEVEN_SECONDARY_TITLE   = "15:00 min/mile";

        super.onCreate(savedInstanceState);
        getSupportActionBar().setCustomView(R.layout.action_bar_5_7);
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu; this adds items to the action bar if it is present.
        getMenuInflater().inflate(R.menu.menu_workout_5_7, menu);
        return true;
    }
