...
public class Adv_9_4 extends FifteenPartActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PART_FOURTEEN_DURATION = 20 * 1000 * 60;
        PART_FIFTEEN_DURATION  = 20 * 1000 * 60;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_adv_9_4, menu);
        return true;
    }
