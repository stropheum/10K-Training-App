...
public class Workout_8_3 extends TwelvePartActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        PART_ONE_DURATION    = 15 * 100 * 60;
        PART_TWO_DURATION    = 3 * 1000 * 60;
        PART_THREE_DURATION  = 15 * 100 * 60;
        PART_FOUR_DURATION   = 3 * 1000 * 60;
        PART_FIVE_DURATION   = 15 * 100 * 60;
        PART_SIX_DURATION    = 3 * 1000 * 60;
        PART_SEVEN_DURATION  = 15 * 100 * 60;
        PART_EIGHT_DURATION  = 3 * 1000 * 60;
        PART_NINE_DURATION   = 15 * 100 * 60;
        PART_TEN_DURATION    = 3 * 1000 * 60;
        PART_ELEVEN_DURATION = 20 * 1000 * 60;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_workout_8_3, menu);
        return true;
    }
