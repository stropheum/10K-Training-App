...
public class Beg_9_2 extends SevenPartActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PART_SIX_SECONDARY_TITLE   = "9:00 min/mile";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_beg_9_2, menu);
        return true;
    }
