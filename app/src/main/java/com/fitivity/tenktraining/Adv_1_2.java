...
public class Adv_1_2 extends FourteenPartActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PART_THIRTEEN_DURATION = 25 * 1000 * 60;
        ...
        PART_THIRTEEN_SECONDARY_TITLE = "5:00 min/mile";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_adv_1_2, menu);
        return true;
    }
