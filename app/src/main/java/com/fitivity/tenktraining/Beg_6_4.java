...
public class Beg_6_4 extends FivePartActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PART_FOUR_SECONDARY_TITLE  = "10:00 min/mile";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_beg_6_4, menu);
        return true;
    }
