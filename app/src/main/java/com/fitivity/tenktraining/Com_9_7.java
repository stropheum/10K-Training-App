...
public class Com_9_7 extends ElevenPartActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PART_TEN_SECONDARY_TITLE    = "6:00 min/mile";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_com_9_7, menu);
        return true;
    }
