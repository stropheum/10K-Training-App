...
public abstract class OnePartActivity extends ActionBarActivity {
    ...
    protected boolean partOneFirstRun;

    // Value to track the first tick of each timer
    protected boolean partOneFirstTick;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_one_part);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == 16908332) {
            stopService(new Intent(OnePartActivity.this, SpeedCalculationService.class));
            stopService(i);
...
//    }
    ...
    public void partOneBegin() {
        ...
        nextButton.setEnabled(false); // Enable next button when first part begins
