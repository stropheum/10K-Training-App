...
public class Adv_2_7 extends NinePartActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PART_SEVEN_DURATION = 40 * 1000 * 60;
        PART_EIGHT_DURATION = 20 * 1000 * 60;
        ...
        PART_EIGHT_SECONDARY_TITLE = "6:00 min/mile";
        PART_NINE_SECONDARY_TITLE  = "5:00 min/mile";

        super.onCreate(savedInstanceState);
        getSupportActionBar().setCustomView(R.layout.action_bar_2_7);
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu; this adds items to the action bar if it is present.
        getMenuInflater().inflate(R.menu.menu_adv_2_7, menu);
        return true;
    }
