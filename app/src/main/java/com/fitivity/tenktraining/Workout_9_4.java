...
public class Workout_9_4 extends FifteenPartActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PART_THIRTEEN_DURATION = 5 * 1000 * 60;
        ...
        PART_NINE_GOAL_PACE   = 7.0;
        PART_TEN_GOAL_PACE    = 15.0;
        PART_ELEVEN_GOAL_PACE = 7.0;
        PART_TWELVE_GOAL_PACE = 15.0;
        PART_THIRTEEN_GOAL_PACE = 20.0;
        PART_FOURTEEN_GOAL_PACE = 7.0;
        PART_FIFTEEN_GOAL_PACE = 15.0;
        ...
        PART_THIRTEEN_SECONDARY_TITLE = "20:00 min/mile";
        PART_FOURTEEN_SECONDARY_TITLE = "7:00 min/mile";
        PART_FIFTEEN_SECONDARY_TITLE = "15:00 min/mile";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_workout_9_4, menu);
        return true;
    }
