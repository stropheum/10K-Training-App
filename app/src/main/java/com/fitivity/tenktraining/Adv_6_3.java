...
public class Adv_6_3 extends ThirteenPartActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PART_TWELVE_DURATION   = 20 * 1000 * 60;
        ...
        PART_TWELVE_GOAL_PACE   = 5.5;
        PART_THIRTEEN_GOAL_PACE = 18.0;
        ...
        PART_TWELVE_SECONDARY_TITLE   = "5:30 min/mile";
        PART_THIRTEEN_SECONDARY_TITLE = "18:00 min/mile";

        super.onCreate(savedInstanceState);
        getSupportActionBar().setCustomView(R.layout.action_bar_6_3);
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu; this adds items to the action bar if it is present.
        getMenuInflater().inflate(R.menu.menu_adv_6_3, menu);
        return true;
    }
