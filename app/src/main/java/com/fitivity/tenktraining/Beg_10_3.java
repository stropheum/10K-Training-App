...
public class Beg_10_3 extends SixPartActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        PART_ONE_DURATION   = 35 * 1000 * 60;
        PART_TWO_DURATION   = 6 * 1000 * 60;
        PART_THREE_DURATION = 20 * 1000 * 60;
        PART_FOUR_DURATION  = 6 * 1000 * 60;
        PART_FIVE_DURATION  = 15 * 1000 * 60;
        ...
        PART_FIVE_SECONDARY_TITLE  = "9:30 min/mile";
        PART_SIX_SECONDARY_TITLE   = "15:00 min/mile";

        super.onCreate(savedInstanceState);
        getSupportActionBar().setCustomView(R.layout.action_bar_10_3);
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu; this adds items to the action bar if it is present.
        getMenuInflater().inflate(R.menu.menu_beg_10_3, menu);
        return true;
    }
