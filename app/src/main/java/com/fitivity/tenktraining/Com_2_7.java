...
public class Com_2_7 extends FivePartActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        PART_ONE_DURATION   = 12 * 1000 * 60;
        PART_TWO_DURATION   = 12 * 1000 * 60;
        PART_THREE_DURATION = 12 * 1000 * 60;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_com_2_7, menu);
        return true;
    }
